...
1. The user enters `find CRITERIA` which will be parsed by the `Parser` class. The `Parser` class will create a new `FindCommand`
object.

2. `EventList#filterWith()` will be called which will create a ArrayList containing events that match the specified criteria.

3. `UI#printFilteredEventList` is called to print out the events.
...
>>>>>>> e369a17fe371023a3a0ffbe95eac44c9615844a0
